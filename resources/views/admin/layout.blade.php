...
<head>
    ...
    <link rel="stylesheet" href="ionicframework.com/ionicons/2.0.1/css/ionicons.min.css">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                <img src="dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                    style="opacity: .8">
                <span class="brand-text font-weight-light">ELMS</span>
            </a>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{route('timetable.create')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Add New Timetable</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                 <a href="{{route('timetable.read')}}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>View Existing Timetable</p>
                                    </a> 
                                </li>
                            </ul>
                        </li>
